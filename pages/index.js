  ...
  return (
    <>
      ...
      <section className="cta-section" id="cta" data-animate>
        <div className="container">
          <div className={`cta-content ${isVisible.cta ? 'fade-in' : ''}`}>
            <h2 className="cta-title">Pret a Commencer Votre Aventure?</h2>
            <p className="cta-text">Inscrivez-vous maintenant et recevez une reponse sous 24h</p>
            <button className="cta-button-large" onClick={() => setIsModalOpen(true)}>
...
function RegistrationForm({ onClose }) {
  ...
  if (success) {
    return (
      <div className="success-message">
        ...
        <p>Nous vous contactons sous 24h</p>
      </div>
    )
  }
  ...
  return (
    <form onSubmit={handleSubmit} className="registration-form">
      ...
      <div className="form-row">
        ...
        <div className="form-group">
          ...
          <input
            ...
            onChange={handleChange}
            required
            placeholder="Ex: Medecine, Ingenierie, etc."
          />
        </div>
      </div>
      ...
      <div className="form-row">
        <div className="form-group">
          ...
          <input
            ...
            onChange={handleChange}
            required
            placeholder="Ex: Moscou, Saint-Petersbourg, etc."
          />
        </div>
        <div className="form-group">
      ...
      <div className="form-group">
        <label>Parlez-nous de votre projet d'etudes</label>
        <textarea
          name="studyProject"
